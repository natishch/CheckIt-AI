...
- docs/AH_07_FACT_ANALYST_NODE_SUMMARY.md - Fact Analyst node with LLM-based claim extraction and evaluation
- docs/AH_08_WRITER_NODE_SUMMARY.md - Writer node with few-shot prompting and multi-provider LLM support
